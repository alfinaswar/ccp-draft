        ...
        <div class="col-lg-12">
            <div class="card">
                ...
                <form id="formFeasibilityStudy" action="{{ route('fs.store') }}" method="POST" autocomplete="off">
                    @csrf
                    <input type="hidden" name="idPengajuan" value="{{ $idPengajuan }}" required>
                    <input type="hidden" name="idPengajuanItem" value="{{ $idPengajuanItem }}" required>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <select class="form-select select2 @error('NamaBarang') is-invalid @enderror"
                                    name="NamaBarang" id="NamaBarang" required>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text"
                                    ...
                                    value="{{ old('NilaiInvestasi', isset($data->getRekomendasi->getRekomedasiDetail[0]['HargaNego']) ? number_format($data->getRekomendasi->getRekomedasiDetail[0]['HargaNego'], 0, ',', '.') : '0') }}"
                                    placeholder="Masukkan nilai investasi"
                                    oninput="this.value = formatRupiah(this.value); calculateDependentFields();" required>
                            ...
                            <div class="col-12">
                                ...
                                <textarea class="ckeditor @error('Spesifikasi') is-invalid @enderror" id="ckeditor" name="Spesifikasi" rows="10"
                                    placeholder="Masukkan spesifikasi" required>{{ old('Spesifikasi', $data->getRekomendasi->getRekomedasiDetail[0]) }}</textarea>
                                @error('Spesifikasi')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Bunga Tetap akan dihitung otomatis" required>
                                        @error('BungaTetap')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Penyusutan akan dihitung otomatis" required>
                                        @error('Penyusutan')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Maintenance akan dihitung otomatis" required>
                                        @error('Maintenance')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            oninput="formatRupiahAndCalculateTotal()" required>
                                        @error('SewaGedung')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            oninput="formatRupiahInput(this); calculateTotalVariable();" required>
                                        @error('Konsumable')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text"
                                            ...
                                            placeholder="Masukkan total biaya variable" required>
                                    ...
                                    {{--
                                    <div class="mb-3">
                                        <label for="JumlahPakaiPerHari" class="form-label fw-bold">Jumlah Pakai Per
                                            Hari</label>
                                        <input type="text"
                                            class="form-control @error('JumlahPakaiPerHari') is-invalid @enderror"
                                            name="JumlahPakaiPerHari" id="JumlahPakaiPerHari"
                                            value="{{ old('JumlahPakaiPerHari') }}"
                                            placeholder="Masukkan jumlah pakai per hari"
                                            required>
                                        @error('JumlahPakaiPerHari')
                                            <div class="invalid-feedback">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="mb-3">
                                        <label for="JumlahAlat" class="form-label fw-bold">Jumlah Alat</label>
                                        <input type="text"
                                            class="form-control @error('JumlahAlat') is-invalid @enderror"
                                            name="JumlahAlat" id="JumlahAlat" value="{{ old('JumlahAlat') }}"
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3">
                                            ...
                                            <input type="text"
                                                ...
                                                oninput="calculateDependentFields();" required>
                                            @error('BungaBank')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm jumlah-pasien-umum @error('rugi_laba.JumlahPasien.' . $i) is-invalid @enderror"
                                                                id="JumlahPasienUmum{{ $i }}"
                                                                name="rugi_laba[JumlahPasien][{{ $i }}]"
                                                                value="{{ old("rugi_laba.JumlahPasien.$i") }}"
                                                                placeholder="Masukan jumlah pasien" required>
                                                            @error('rugi_laba.JumlahPasien.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm jumlah-pasien-bpjs @error('rugi_laba.JumlahPasienBpjs.' . $i) is-invalid @enderror"
                                                                id="JumlahPasienBpjs{{ $i }}"
                                                                name="rugi_laba[JumlahPasienBpjs][{{ $i }}]"
                                                                value="{{ old("rugi_laba.JumlahPasienBpjs.$i") }}"
                                                                placeholder="Masukan jumlah pasien Bpjs" required>
                                                            @error('rugi_laba.JumlahPasienBpjs.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.TarifUmum.' . $i) is-invalid @enderror"
                                                                id="TarifUmum{{ $i }}"
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.TarifBpjs.' . $i) is-invalid @enderror"
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.Revenue.' . $i) is-invalid @enderror"
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.TotalBiaya.' . $i) is-invalid @enderror"
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.BiayaTetap.' . $i) is-invalid @enderror"
                                                                ...
                                                                placeholder="Masukan biaya tetap" required>
                                                            @error('rugi_laba.BiayaTetap.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.BiayaVariable.' . $i) is-invalid @enderror"
                                                                ...
                                                                placeholder="Masukan biaya variable" required>
                                                            @error('rugi_laba.BiayaVariable.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.NetProfit.' . $i) is-invalid @enderror"
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.Ebitda.' . $i) is-invalid @enderror"
                                                                name="rugi_laba[Ebitda][{{ $i }}]"
                                                                id="Ebitda{{ $i }}"
                                                                value="{{ old("rugi_laba.Ebitda.$i") ? 'Rp ' . number_format((int) preg_replace('/\D/', '', old("rugi_laba.Ebitda.$i")), 0, ',', '.') : '' }}"
                                                                placeholder="Masukan EBITDA" required>
                                                            @error('rugi_laba.Ebitda.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm rupiah-input @error('rugi_laba.AkumEbitda.' . $i) is-invalid @enderror"
                                                                ...
                                                                placeholder="Masukan akumulasi EBITDA" required>
                                                            @error('rugi_laba.AkumEbitda.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
                                                ...
                                                <tr>
                                                    ...
                                                    @for ($i = 1; $i <= 8; $i++)
                                                        <td>
                                                            <input type="text"
                                                                class="form-control form-control-sm @error('rugi_laba.RoiTahunKe.' . $i) is-invalid @enderror"
                                                                name="rugi_laba[RoiTahunKe][{{ $i }}]"
                                                                id="RoiTahunKe{{ $i }}"
                                                                value="{{ old("rugi_laba.RoiTahunKe.$i") }}"
                                                                placeholder="Masukan ROI tahun ke-{{ $i }}"
                                                                required>
                                                            @error('rugi_laba.RoiTahunKe.' . $i)
                                                                <div class="invalid-feedback">{{ $message }}</div>
                                                            @enderror
                                                        </td>
                                                    @endfor
...
@push('js')
    ...
    @endif
    <script>
        // Custom round function sesuai aturan:
        // jika angka dibelakang koma di atas 5, pembulatan ke atas.
        // jika dibawah, ke bawah.
        function roundAturan(x) {
            if (typeof x !== 'number') x = Number(x);
            if (isNaN(x)) return 0;
            var decimal = x - Math.floor(x);
            if (decimal === 0) return Math.floor(x);
        ...
        function calculateDependentFields() {
            ...
            if (nilaiInvestasi && estimasiPembiayaan && bungaBank) {
                bungaTetap = roundAturan((nilaiInvestasi * estimasiPembiayaan) * bungaBank);
            }

            // 2. PENYUSUTAN = NilaiInvestasi / UmurEkonomis
            let penyusutan = 0;
            if (nilaiInvestasi && umurEkonomis) {
                penyusutan = roundAturan(nilaiInvestasi / umurEkonomis);
            }

            // 3. MAINTENANCE = NilaiInvestasi * Maintenance2(%)
            let maintenance = 0;
            if (nilaiInvestasi && maintenance2) {
                maintenance = roundAturan(nilaiInvestasi * maintenance2);
            }
    ...
    <script>
        ...
        function autoGenerateJumlahPasienUmumAndBpjs() {
            ...
            // Custom roundAturan di sini
            function roundAturanLocal(x) {
                if (typeof x !== 'number') x = Number(x);
                if (isNaN(x)) return 0;
                var decimal = x - Math.floor(x);
                if (decimal === 0) return Math.floor(x);
            ...
            let bpjs = [];
            // Tahun 1
            bpjs[0] = roundAturanLocal(jumlahPakaiPertahun * 0.85);
            // Tahun 2-8 (index 1..7)
            for (let i = 1; i < 8; i++) {
                let prev = bpjs[i - 1];
                let percent = 0.10;
                if (i === 3) percent = 0.075; // Tahun 4
                bpjs[i] = roundAturanLocal(prev + (prev * percent));
            }
            ...
            umum[0] = roundAturanLocal(jumlahPakaiPertahun - bpjs[0]);
            // Tahun 2-8
            for (let i = 1; i < 8; i++) {
                let prev = umum[i - 1];
                let percent = 0.10;
                if (i === 3) percent = 0.075; // Tahun 4
                umum[i] = roundAturanLocal(prev + (prev * percent));
            }
            // Set result to input
            for (let i = 0; i < 8; i++) {
    ...
    <script>
        function updateBiayaTetapRugiLaba() {
            ...
            // pakai aturan pembulatan custom
            function roundAturanLocal(x) {
                if (typeof x !== 'number') x = Number(x);
                if (isNaN(x)) return 0;
                var decimal = x - Math.floor(x);
            ...
            for (let tahun = 1; tahun <= 8; tahun++) {
                if (tahun === 1) {
                    ...
                    biayaTetap[tahun] = roundAturanLocal(biayaTetap[tahun - 1] + biayaTetap[tahun - 1] * 0.05);
                } else if (tahun === 5) {
                    biayaTetap[tahun] = roundAturanLocal(biayaTetap[tahun - 1] + biayaTetap[tahun - 1] * 0.10);
                } else {
                    biayaTetap[tahun] = roundAturanLocal(biayaTetap[tahun - 1] + biayaTetap[tahun - 1] * 0.10);
                }
        ...
        function updateBiayaVariableRugiLaba() {
            ...
            for (let i = 1; i <= 8; i++) {
                ...
                if (i === 1) {
                    ...
                    biayaVar = roundAturanLocal((konsumableNaik * totalPasien) + baseDokter);
                }
    ...
    <script>
        ...
        function hitungRugiLabaSemuaTahun() {
            ...
            for (let i = 1; i <= tahun_count; i++) {
                ...
                let valRevenue = roundAturanLocal((valJumlahPasienUmum * valTarifUmum) + (valJumlahPasienBpjs *
                    valTarifBpjs));
                ...
                let valRoi = valInvestasi ? roundAturanLocal((valAkumEbitda / valInvestasi) * 100) : 0;
                if (roiTahunKe) {
