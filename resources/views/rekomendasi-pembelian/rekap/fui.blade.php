    ...
    <div>
        ...
        <table>
            ...
            <tr>
                ...
                <td style="width:2%;">:</td>
                <td style="width:18%;">
                    {{ $usulan->Tanggal ? \Carbon\Carbon::parse($usulan->Tanggal)->translatedFormat('d F Y') : '-' }}
                </td>
                <td style="width:13%;">Tanggal</td>
                <td style="width:2%;">:</td>
                <td style="width:18%;">
                    {{ $usulan->Tanggal2 ? \Carbon\Carbon::parse($usulan->Tanggal2)->translatedFormat('d F Y') : '-' }}
                </td>
            </tr>
            <tr>
                <td>Nama Kepala Divisi</td>
                <td>:</td>
                <td>{{ optional($usulan->getKadiv)->name ?? '-' }}</td>
                <td>Nama Kepala Divisi</td>
                <td>:</td>
                <td>{{ optional($usulan->getKadiv2)->name ?? '-' }}</td>
            </tr>
            <tr>
                <td>Divisi</td>
                <td>:</td>
                <td>{{ optional($usulan->getDepartemen)->Nama ?? '-' }}</td>
                <td>Divisi</td>
                <td>:</td>
                <td>{{ optional($usulan->getDepartemen2)->Nama ?? '-' }}</td>
            </tr>
            <tr>
                <td>Kategori</td>
                <td>:</td>
