<style>
    * {
    ...
    table.cetak-hta td {
        ...
        /* Paksa teks wrap, tidak pernah terpotong */
        word-wrap: break-word;
        word-break: break-word;
        overflow-wrap: break-word;
        white-space: normal !important;
        /* batalkan nowrap bila ada */
        overflow: visible;
        /* tampilkan semua isi */
    }
    ...
    table.cetak-hta tr {
        line-height: 1.3;
        /* Baris tidak boleh terpotong antar halaman PDF */
    ...
    /* =============================================
       LEBAR KOLOM — gunakan % agar proporsional
    ============================================= */
    ...
    /* Kolom Deskripsi — diberi ruang lebih, sisanya untuk nilai */
    .col-deskripsi {
        font-size: 7.5pt !important;
        text-align: left;
        vertical-align: top;
    ...
    /* =============================================
       PAGE BREAK — pindah halaman dengan rapi
    ============================================= */
    /* Ubah agar header tabel tidak diulang setiap halaman saat print */
    thead {
    ...
    /* Jangan potong tabel di tengah jika masih muat */
    table.cetak-hta {
    ...
    @media print {
        ...
        /* Hapus efek table-header-group di print */
        thead {
...
<div class="cetak-hta-gpa-global">
    ...
    {{-- ============================================================
         TABEL HTA UTAMA
         Lebar kolom dihitung:
           No        = 24px
           Parameter = 100px
           Per vendor: Deskripsi (auto) + 5 nilai (@14px) + Subtotal (26px)
         ============================================================ --}}
