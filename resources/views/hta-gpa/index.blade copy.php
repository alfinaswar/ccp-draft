                ...
                <div class="card-body">
                    ...
                    <form id="formHtaGpa" action="{{ route('htagpa.store') }}" method="POST" enctype="multipart/form-data">
                                                    ...
                                                    <td>
                                                        @if ($pm == 11)
                                                            <input type="text" class="form-control currency-input-global"
                                                                ...
                                                                readonly>
                                                        @elseif($pm == 2)
                                                            <textarea class="ckeditor" id="ckeditor" name="vendor[{{ $vIdx }}][Deskripsi][]" rows="10"
                                                                placeholder="Masukkan Spesifikasi">{!! $data->getHtaGpa->getDetailHta[$vIdx]->Deskripsi[$key] ?? '' !!}</textarea>
                                                        @else
                        ...
                        <div class="mt-3 d-flex justify-content-end">
                            ...
                            @endphp
                            @if ($showAjukan && ($data->Status ?? '') !== 'Ditolak')
                            ...
                            <div class="table-responsive">
                                ...
                                <table class="table align-middle">
                                    ...
                                    <tbody>
                                        ...
                                        @else
                                            <tr>
                                                <td colspan="16" class="text-center">Belum ada data approval.</td>
                                            </tr>
                                        @endif
                                    </tbody>
                                </table>
