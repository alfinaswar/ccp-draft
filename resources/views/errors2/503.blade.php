...
<head>
    ...
    <title>503 — Layanan Tidak Tersedia | ABPROC</title>
...
<body>
    ...
    <main>
        <div class="card">
            ...
            <div class="icon-wrap">
                <!-- Tools (gear) icon for maintenance -->
                <svg viewBox="0 0 52 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <circle cx="26" cy="26" r="20" stroke="#f59e0b" stroke-width="4" />
                    <g>
                        <path d="M26 17v7l5 3" stroke="white" stroke-width="3" stroke-linecap="round"
                            stroke-linejoin="round" />
                        <circle cx="26" cy="26" r="7" stroke="white" stroke-width="3" fill="none" />
                    </g>
                </svg>
            </div>

            <div class="code">5<em>0</em>3</div>
            <div class="pill">Layanan Tidak Tersedia</div>

            <h1>Sedang Dilakukan Pemeliharaan Sistem</h1>
            <p class="desc">
                Untuk sementara layanan tidak dapat diakses.<br>
            ...
            <div class="actions">
                ...
                <button onclick="location.reload()" class="btn btn-outline">
                    <svg width="15" height="15" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                        ...
                        <path d="M4 4v6h6" />
                        <path d="M20 20v-6h-6" />
                        <path d="M5 19a9 9 0 0 1 14 0" />
                        <path d="M19 5a9 9 0 0 0-14 0" />
                    </svg>
                    Coba Lagi
                </button>
            </div>
