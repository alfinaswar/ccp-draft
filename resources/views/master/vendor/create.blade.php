        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header bg-dark">
                    <h4 class="card-title mb-0">Formulir Tambah Vendor</h4>
                    <p class="card-text mb-0">
                        Silakan isi data vendor baru di bawah ini.
                    </p>
                </div>
                <div class="card-body">
                    <form action="{{ route('vendor.store') }}" method="POST">
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <label for="jenis_vendor" class="form-label"><strong>Jenis</strong></label>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="NamaPic"
                                    ...
                                    placeholder="Nama PIC" value="{{ old('NamaPic') }}">
                                @error('NamaPic')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="NoHpPic"
                                    ...
                                    placeholder="No. HP PIC" value="{{ old('NoHpPic') }}">
                                @error('NoHpPic')
                                    <div class="text-danger mt-1">
                                        {{ $message }}
                                    </div>
