                        ...
                        <div class="row g-3 mb-4">
                            ...
                            <div class="col-md-2">
                                ...
                                <input type="text" name="pengajuan[nominal_rkap]" id="nominal_rkap"
                                    ...
                                    value="{{ $data->NominalRkap ?? 0 }}" placeholder="Contoh: Rp1.000.000"
                                                ...
                                                <div class="tab-pane fade {{ $i == 0 ? 'show active' : '' }}"
                                                                                    ...
                                                                                    <tr>
                                                                                        ...
                                                                                        <td>
                                                                                            <input type="text"
                                                                                                ...
                                                                                                @if (isset($data->getVendor[$i]) && $data->getVendor[$i]->NamaVendor) value="{{ $data->getVendor[$i]->NamaPic ?? '' }}" @endif>
                                                                                        </td>
                                                                                    </tr>
                                                                                    <tr>
                                                                                        <th>No HP PIC</th>
                                                                                        <td>
                                                                                            <input type="text"
                                                                                                ...
                                                                                                @if (isset($data->getVendor[$i]) && $data->getVendor[$i]->KontakPic) value="{{ $data->getVendor[$i]->KontakPic ?? '' }}" @endif>
                                                                                        </td>
                                                                                    </tr>
                                                                                </table>
                                                                            </div>
                                                    ...
                                                    <div class="table-responsive">
                                                                            ...
                                                                            <td>
                                                                                <div class="input-group">
                                                                                    <input type="text"
                                                                                        ...
                                                                                        value="{{ $vendorTab ? number_format((int) str_replace(['.', ','], '', $vendorTab->HargaSatuan), 0, ',', '.') : '' }}">
                                                        ...
                                                        <script>
                                                            ...
                                                            // Modified: Support koma untuk persen saja!
                                                            function parseNum{{ $i }}(val, allowComma = false) {
                                                                if (typeof val === 'string') {
                                                                    // Jika allowComma true (untuk persen),
                                                                    // perbolehkan semua digit, koma, dan titik untuk desimal
                                                                    if (allowComma) {
                                                                        // Allow "." as decimal or "," as decimal, and ignore multiple separators
                                                                        val = val.replace(/[^0-9\.,\-]/g, '');
                                                                        val = val.replace(/\.(?=.*\.)/g, ''); // keep only the last dot if multiple
                                                                        val = val.replace(/\,/g, '.'); // change comma to dot
                                                                    } else {
                                                                        val = val.replace(/[^0-9\,\-]/g, "");
                                                                        val = val.replace(/\./g, "");
                                                                        val = val.replace(',', '.');
                                                            ...
                                                            function hitungOtomatis{{ $i }}(elem) {
                                                                ...
                                                                let diskon;
                                                                // parseNum allow koma jika jenisDiskon Persen
                                                                ...
                                                                if (jenisDiskon === 'Rp') {
                                                                    ...
                                                                    // Clean non-decimal for persen
                                                                    // Let the user type , or .
                                                                ...
                                                                $('#table-detail-vendor-{{ $i }}').on('input change blur',
                                                                    ...
                                                                    function() {
                                                                        ...
                                                                        if ($(this).hasClass('currency-input-{{ $i }}') &&
                                                                            ...
                                                                            'Persen') {
                                                                            // For persen, force only valid decimal entry (replace , to .)
