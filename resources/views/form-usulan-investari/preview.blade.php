...
<head>
    ...
    <title>Preview Usulan Investasi</title>
...
<div class="container">
    <div class="approval-wrapper">
        ...
        <div class="text-center mb-4">
            ...
            <p class="text-muted mb-0">Sistem Persetujuan Usulan Investasi</p>
        </div>
        ...
        <div class="card card-custom">
            <div class="card-header card-header-custom text-center">
                <h4 class="d-inline-block"><i class="ti ti-file-description me-2"></i>Preview Usulan Investasi &amp; Lampiran</h4>
            ...
            <div class="card-body p-4">
                ...
                <div class="mb-4">
                    <h5 class="mb-1">Lampiran Usulan dalam PDF</h5>
                    <ul>
                        @php
                            $filename = $fileName ?? null;
                            $idPengajuan = $pengajuan->id ?? null;
                            $downloadUrl = $downloadUrl ?? null;
                            // Fallback if downloadUrl not provided by backend
                            if(!$downloadUrl && $filename && $idPengajuan){
                        ...
                        @else
                            <li class="text-danger">File lampiran PDF usulan tidak tersedia.</li>
                        @endif
                    </ul>
                    @if($downloadUrl && $filename)
