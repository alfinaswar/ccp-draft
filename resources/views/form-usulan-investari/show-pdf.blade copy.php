        ...
        <table class="table align-middle" width="100%">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td>
                        {{ isset($rekomDetail->HargaAwal) ? rupiah((int) preg_replace('/[^\d]/', '',
                        $rekomDetail->HargaAwal)) : 'Rp 0' }}
                    </td>
                    <td>
                        {{ isset($rekomDetail->HargaNego) ? rupiah((int) preg_replace('/[^\d]/', '',
                        $rekomDetail->HargaNego)) : 'Rp 0' }}
                    </td>
                    <td>
